...
This thesis investigates a large scale \texttt{L-BFGS-B} optimizer for smooth functions and how it can be modified to optimize non-smooth functions. The new code is called \texttt{L-BFGS-B-NS}. The changes required include a relaxation of the Wolfe condition, some other changes to the line search algorithm and changes to the termination condition. Some experiments illustrate the results applied to a non-smooth function.
}
...
I also would like to thank Allan Kaku and Anders Skajaa for earlier contributions to other versions of the code, and Jorge Nocedal, Ciyou Zhu, Richard Byrd and Peihuang Lu, for letting us change their original code.
...
\dedicatory{Dedicated to my mother and Dr. Ian Malcolm} % Dedication text
