...
This thesis investigates a large scale \texttt{L-BFGS-B} optimizer for smooth functions and how it can be expanded to optimize non-smooth functions \texttt{L-BFGS-B-NS}. The changes required include a relaxation of the Wolfe condition, some changes to the line search algorithm and changes to the termination condition. Some experiments illustrate the results applied to a non-smooth function.
}
