...
This thesis investigates a large scale optimizer for smooth functions and how it can be expanded to include non-smooth functions. The problem was solved by changing some of the conditions in the line search and in the termination condition. Some experiments illustrate the results applied to a non-smooth modified rosenbrock function.
